...
class CourseSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            COUR_UNIQUE_ID,
            COUR_COURSE_TITLE,
            COUR_COURSE_DESCRIPTION,
            COUR_COURSE_ID,
            COUR_PARENT_INSTITUTION
        )
...
class CourseOutputSerializer(ModelSerializer):
    ...
    """
    parent_institution = SerializerMethodField(
        source='get_parent_institution'
    )
    parent_institution_url = SerializerMethodField(
        source='get_parent_institution_url'
    )
    ...
    def get_parent_institution_url(self, obj):
        return "/courses/api/institution/retrieve/{}".format(
            obj.parent_institution.unique_id
        )
